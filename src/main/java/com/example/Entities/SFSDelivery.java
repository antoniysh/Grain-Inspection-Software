...
public class SFSDelivery {
	//----------FIELDS------------
			...
			@Column(name = "oil", columnDefinition = "double CHECK (oil < 1)")
			private double oil;
		...
		public SFSDelivery(Long id, Date arrived, String licensePlate, String waybillNumber, int waybillQuantity,
				String orderId, String supplier, String intakePlace, boolean accepted, double moisture,
				double foreignMatter, double oil, double tW, int insectsPerKilo, Integer netScaleQuantity,
				String remarks) {
			super();
			this.id = id;
