...
public class WheatDelivery {
	...
	@Column(name = "protein", columnDefinition = "double CHECK (protein < 1)")
	private double protein;
	
	@Column(name = "gluten", columnDefinition = "double CHECK (gluten < 1)")
	...
	public WheatDelivery() {
		super();
	}

	
	
	public WheatDelivery(Long id, Date arrived, String licensePlate, String waybillNumber, int waybillQuantity,
			String orderId, String supplier, String intakePlace, boolean accepted, double moisture,
			double foreignMatter, double tW, double protein, double gluten, int insectsPerKilo,
			Integer netScaleQuantity, String remarks) {
		super();
		this.id = id;
