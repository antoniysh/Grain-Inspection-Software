...
public class StatisticBySupplierWheat {
		...
		public StatisticBySupplierWheat(String name, double moisture, double foreignMatter, double tw, double protein,
		...
		public StatisticBySupplierWheat() {
			super();
		}
		public int getCount() {
			return count;
